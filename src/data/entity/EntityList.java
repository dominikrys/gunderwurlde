...
public enum EntityList {
    ...
    // Player
    PLAYER("assets/img/entity/player/player_1.png"),
    PLAYER_1("assets/img/entity/player/player_1.png"),
    PLAYER_2("assets/img/entity/player/player_2.png"),
    PLAYER_3("assets/img/entity/player/player_3.png"),
    PLAYER_4("assets/img/entity/player/player_4.png"),

    // Enemy
    ZOMBIE("assets/img/entity/enemy/zombie.png"),

    // Projectile
    BASIC_BULLET("assets/img/entity/projectile/basic_bullet.png"),
