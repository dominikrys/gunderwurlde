...
public class Zombie extends Enemy implements HasContactDamage {
    ...
    public Zombie() {
        this(DEFAULT_HEALTH, DEFAULT_MOVESPEED, 1, DEFAULT_DROPS, DEFAULT_SCORE_ON_KILL);
    }
    ...
    public Enemy makeCopy() {
        return new Zombie(this.maxHealth, this.moveSpeed, this.sizeScaleFactor, this.drops, this.scoreOnKill);
    }
