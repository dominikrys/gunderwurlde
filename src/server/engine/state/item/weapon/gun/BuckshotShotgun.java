...
public class BuckshotShotgun extends Shotgun {
    ...
    public LinkedList<Projectile> getShotProjectiles(Pose gunPose, Team team) {
        int oldProjectsPileShot = projectilesPerShot;
        projectilesPerShot = (int) (projectilesPerShot * (Double.valueOf(ammoUsed) / ammoPerShot));
        LinkedList<Projectile> shotProjectiles = super.getShotProjectiles(gunPose, team);
        projectilesPerShot = oldProjectsPileShot;
